 ...
 * @license MIT
 */
!function(t){t((function(){const e=t("#wsu-content a");console.log("A total of "+e.length+" hyperlinks were found."),e.each((function(){const e=t(this),s=/(https:\/\/daesa\.wsu\.edu\/(?!coug-succ-wds\/))(.+)/,l=/(^\/(?!coug-succ-wds\/))(.*)$/;let i=e.attr("href");console.log("Evaluating link href "+i+"."),null!==i.match(s)&&(console.log("Replacing link href "+i+"."),i=i.replace(s,"$1coug-succ-wds/$2"),e.attr("href",i)),null!==i.match(l)&&(console.log("Replacing link href "+i+"."),i=i.replace(l,"$1coug-succ-wds/$2"),e.attr("href",i))}))}))}(jQuery),
/*!***
 * gpaCalc.js - v0.13.0
